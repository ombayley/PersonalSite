...
### 🚀 Deployment
The main application is deployed on Netlify and can be accessed at [https://www.netlify.com/]
The website is setup to re-build and deploy everytime the main branch of the repoesitory is updated on github.
